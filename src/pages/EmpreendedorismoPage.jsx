                  ...
                  <div className="border-t border-white/10 px-4 pb-4 pt-4 dark:border-stone-300 cyberpunk:border-white/10">
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        <p className="text-[11px] font-mono uppercase tracking-widest text-zinc-500 dark:text-stone-600 cyberpunk:text-[#00e8ff]">
                          Videos da disciplina
                        </p>
                        <div className="space-y-2">
                          {referenceVideoMaterials.map((video) => (
                            <a
                              key={video.id}
                              href={video.url}
                              target="_blank"
